...
class TakeoutEntityController extends EntityController {
    ...
    protected function assemblefood($entity) {
        ...
        if (!empty($entity->field_takeout_order)) {
            $entity->order = Entity\Order\Order::load(entity_request(array('id'=>$entity->field_takeout_order[0]['id'])));
        }
